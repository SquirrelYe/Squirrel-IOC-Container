...
export type DependenciesValueItem = {
    id: string;
    parameterKey: string;
    parameterIndex: number;
};
export type DependenciesValue = {
    propertyDeps: Array<DependenciesValueItem>;
    parameterDeps: Array<DependenciesValueItem>;
    postConstructDeps: Array<string>;
};
